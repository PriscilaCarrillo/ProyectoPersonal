...
<head>
    ...
    <i class="bi bi-envelope"></i> <!-- icono de mail -->
...
<jsp:include page="Navbar.jsp"></jsp:include>   <!-- codigo navbar -->
<body>
    <header>
    ...
    <div id="titulo">
        <h1 class="text-center"> InclusiveTrip </h1> <!-- titulo de la pagina web -->
    </div>
    <br>
    <div id="pres">
            ...
            <footer> <!-- pie de página-->
                <div id="contacto" class="pt-5 container-fluid">
                    <div class="card text-center">
                        <div class="card-body fondo-img">
                            <h4 class="card-title"> <b>InclusiveTrip</b></h4>
...
</svg> inclusivetrip.2023@gmail.com
<div id="pres5"></div> 
